            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
               ...
               <tr>
                 ...
                 <td><a rel="{{ $image->id }}" rel1="delete-alt-image" <?php /*href="{{ url('/admin/delete-product/'.$product->id) }}"*/ ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Product Image">Delete</a></td>
               </tr>
               @endforeach
              </tbody>
            </table>

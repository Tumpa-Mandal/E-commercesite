              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a rel="{{ $coupon->id }}" rel1="delete-coupon" <?php /*href="{{ url('/admin/delete-product/'.$product->id) }}"*/ ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Coupon">Delete</a></td>
                </tr>

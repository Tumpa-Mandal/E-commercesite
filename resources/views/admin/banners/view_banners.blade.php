              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a rel="{{ $banner->id }}" rel1="delete-banner" <?php /*href="{{ url('/admin/delete-product/'.$product->id) }}"*/ ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete banner">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>

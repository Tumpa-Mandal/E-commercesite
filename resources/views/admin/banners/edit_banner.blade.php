    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-banner/'.$bannerDetails->id) }}" name="edit-banner" id="edit-banner" novalidate="novalidate">{{ csrf_field() }}
